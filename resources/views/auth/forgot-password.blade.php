                    ...
                    <div class="card-body">
                        ...
                        <div class="p-3">
                            <form class="form-horizontal mt-3" method="POST" action="{{ route('password.email') }}">
                                ...
                                Şifre sıfırlama linki göndermemiz için <strong>E-mail</strong> adresininizi girin!
                                ...
                                <div class="form-group pb-2 text-center row mt-3">
                                    <div class="col-12">
                                        <button class="btn btn-primary w-100 waves-effect waves-light" type="submit">Email Gönder</button>
                                    </div>
                                </div>
                            </form>
                        </div>
