    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Günlük Fatura Raporu</h4>
                        <div>
                            <form method="GET" action="{{ route('daily.invoice.pdf')}}" target="_blank" id="dailyInvoiceReport">
                                <div class="row mt-4">
                                    <div class="col-md-4">
