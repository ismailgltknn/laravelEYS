        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Ödeme Raporu</h4>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="invoice-title">
                                    <h4 class="float-end font-size-16"><strong>Fatura No. #{{ $payment->invoice->invoice_no}}</strong></h4>
                                    <h3>
                                ...
                                <div>
                                    ...
                                    <div class="">
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td colspan="7" class="text-center"><strong>Ödeme Özeti</strong></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="4" class="text-center"><strong>Tarih</strong></td>
                                                        <td colspan="3" class="text-center"><strong>Ödenen Miktar</strong></td>
                                                    </tr>
                                                    @php
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="3" class="text-center"><strong>{{ $item->current_paid_amount }}</strong></td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
                                            </table>
                                        ...
                                        <div class="d-print-none">
                                            <div class="float-end">
                                                <a href="javascript:window.print()" title="Çıktı Al" class="btn btn-success waves-effect waves-light"><i class="fa fa-print"></i> Yazdır</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
