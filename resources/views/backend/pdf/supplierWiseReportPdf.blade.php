        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Tedarikçi Stok Raporu</h4>
                    
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item active">Tedarikçi Stok Raporu</li>
                        </ol>
                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="">
                                        <div class="table-responsive">
                                            <h3 class="text-center"><strong>Tedarikçi: </strong>{{ $allData[0]->supplier->name}}</h3>
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                        <th>#</th>
